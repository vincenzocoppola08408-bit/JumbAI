...
path = Path(r"C:\Users\vince\OneDrive\Desktop\JumbAI_Site\docs") / "Buongiorno 24.09.2026.md"
text = r'''# Buongiorno 24.09.2026
...
print('FIRST', path.read_text(encoding='utf-8').splitlines()[0])
